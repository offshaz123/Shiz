# Content Plan — Shaz Marketing Group Blog

Keyword-researched topic backlog for the daily blog Routine. Pick the next unpublished topic
each day, prioritising whichever category has had the fewest recent posts. Add real researched
topics here as they're identified — don't let this list run dry silently.

Research basis: search intent around Meta/Instagram ads for UK small businesses, and automotive
marketing specifically (car buyers researching on social before purchase, purchase-intent local
keywords, dealership social strategy).
...
- Real, specific keyword phrases in the `keywords` array of each post help internal search intent
  matching — don't just reuse generic ones across posts
- When this backlog gets below ~5 unpublished items, do a fresh round of keyword research and
  extend it rather than letting the Routine run dry or repeat topics
