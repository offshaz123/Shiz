...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="whatsapp-fab group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] shadow-lg shadow-black/20 ring-4 ring-[#25D366]/20 transition-transform hover:scale-105 sm:bottom-7 sm:right-7"
    >
